...
int main ()
{
    ...
    //     min, max, average, median, quartile_25, quartile_75, square_deviation,
    // };
    ...
    std::vector<std::vector<InputRow>> toRender = { median };
    std::vector<std::string> toRenderNames = { "median" };
