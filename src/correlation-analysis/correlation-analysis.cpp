...
/**
@brief Вычисление коэффициента Пирсона для корреляционного анализа
@detailed Данная функция вычисляет коэффициент корреляции каждой страны
по двумя последним столбцам выборки и возвращает вектор, содержащий 
вычисленные коэффициенты корреляции по каждой стране
@param Выборка данных, вектор, хранящий в себе выборочные средние значения
@return Коэффициенты корреляции каждой страны
 */
